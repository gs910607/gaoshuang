...
public class Application {
	...
	public static String PROTOCOL_URL="/upload/protocol/";
	
	public static String AFTER_PROTOCOL_URL="/upload/afterProtocol/";
	...
	public static String[] VIDEO_NEIGHBORHOOD_HEADERS_NO = { "信访人姓名", "证件类型", "证件号码", "固定号码", "手机号码",
			...
			"邮政编号", "信访所在地", "详细地址", "信访人国籍", 
//			"信访编号",
			"登记单位",

			"信访目的", "信访日期", "登记科室", "是否同意公开", "随访人", "登记日期",

			"是否匿名", "接访人姓名", "登记人姓名", "信访原因", "信访人数", "涉及人数",
...
//			"videoneihdNum", 
			...
			"videoneihdTitle", "videoneihdRemark", "videoneihdrealName"
//			, "videoneihdVideoWay" 
			};
	public static String[] VIDEO_NEIGHBORHOOD_HEADERS = { "接访ID", "信访人姓名", "证件类型", "证件号码", "固定号码", "手机号码",
			...
			"标题", "办理意见", "信访类型", "接访人单位", "接访人职务", "联系方式", "信息概括" };
	...
	public static String[] VIDEO_NEIGHBORHOOD_DATASTR = { "videoneihdId", "videoneihdName", "videoneihdCardType",
		...
		"videoneihdTitle", "videoneihdHandleOpinion", "videoneihdTypeId",  "videoneihdLiberateCompany",
		"videoneihdPeopleDuty", "videoneihdPeopleContact", "videoneihdRemark" };
	
	public static String[] MEDIATE_DATASTR_MODEL = new String[] { "mediateName", "mediateCompleteAdd",
			"mediateRegisUnit", "mediatePurpose", "mediateDate", "mediateRegisName",
			"mediateRegisBranch", "mediateRegisDate", "mediateNumber", "mediateReason", "mediaterStatus" };

	public static String[] MEDIATE_HEADERS_MODEL = new String[] { "书记员姓名", "书记员单位","登记单位", "调解目的", "调解日期",
	...
	public static String[] ADMIN_HEADERS_MODEL = new String[] { "账号名", "密码", "真实姓名", "手机号码", "备注", "身份证号码","所属区域（数字）" };
