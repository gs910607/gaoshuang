...
//		console.log(params)
//
//		$.get('http://192.168.3.222:8080/api/article/queryArticleAdv.json', params, function(data) {
//			console.log(data.data[0])
//			var sliderList = $(".sliderCarousel").html()
//			for(var i = 0; i < data.data.length; i++) {
//				console.log(data.data[i])
//				sliderList += '<li style="float: left; display: inline; width: 320px; height: 160px;"><a class="slider_a" href="" target="_blank"><img src=' + data.data[i] + '></a></li>';
//			}
...
//	init()
	...
	$.fn.yxMobileSlider = function(settings) {
		...
		return this.each(function() {
			...
			//初始化主体样式
			_this.width(maxWidth).height(s.height/2).css({
				position: 'relative',
				overflow: 'hidden',
				margin: '0 auto'
			}); //设定容器宽高及样式
			...
			$("div", oFocusContainer).width(oFocus.outerWidth(true) * (num+0.25)).css({
			...
			function mobileSettings() {
				...
				console.log(iScale)
				_this.height(s.height * iScale*0.8).width($(window).width());
				oMover.css({
