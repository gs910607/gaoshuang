...
public class OnlineEvaluation {
	 ...
	 * 关联视频调研活动评选表
	 */
	private List<OnlineEvaluationActive> videoResearchActiveinfo;
	...
	public List<OnlineEvaluationActive> getVideoResearchActiveinfo() {
		return videoResearchActiveinfo;
	}
	public void setVideoResearchActiveinfo(
			List<OnlineEvaluationActive> videoResearchActiveinfo) {
